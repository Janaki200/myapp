      ...
      child: Container(
          ...
          child: SizedBox(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              const SizedBox(height: 10,),
              Text(widget.price+"₹",style: const TextStyle(fontSize: 20,color: Colors.blueAccent,fontWeight: FontWeight.w600),),
             Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                MaterialButton(onPressed: () {
                 
                },color: Colors.blueAccent,child: const Text("Customize"),),
                MaterialButton(onPressed: () {
                  
                },color:AppColors.primaryColor,child: const Text("Add to cart"),),
